...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('mainapp_tag', 'slug',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True),
                      keep_default=False)

        # Adding field 'Set.slug'
        db.add_column('mainapp_set', 'slug',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('mainapp_tag', 'slug')

        # Deleting field 'Set.slug'
        db.delete_column('mainapp_set', 'slug')
