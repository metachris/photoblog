...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Set.cover_photo'
        db.add_column('mainapp_set', 'cover_photo',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='set_cover', null=True, to=orm['mainapp.Photo']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Set.cover_photo'
        db.delete_column('mainapp_set', 'cover_photo_id')
