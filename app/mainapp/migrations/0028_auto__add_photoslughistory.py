...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PhotoSlugHistory'
        db.create_table('mainapp_photoslughistory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('photo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mainapp.Photo'])),
            ('slug', self.gf('django.db.models.fields.CharField')(unique=True, max_length=200)),
        ))
        db.send_create_signal('mainapp', ['PhotoSlugHistory'])


    def backwards(self, orm):
        # Deleting model 'PhotoSlugHistory'
        db.delete_table('mainapp_photoslughistory')
    ...
    models = {
        ...
        'mainapp.photoslughistory': {
            'Meta': {'object_name': 'PhotoSlugHistory'},
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'photo': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['mainapp.Photo']"}),
