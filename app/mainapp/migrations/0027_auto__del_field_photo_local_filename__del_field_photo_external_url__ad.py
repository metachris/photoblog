...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('mainapp_photo', 'external_url')

        # Adding field 'Photo.revisions'
        db.add_column('mainapp_photo', 'revisions',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Photo.revision_set'
        db.add_column('mainapp_photo', 'revision_set',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Photo.fn_ext'
        db.add_column('mainapp_photo', 'fn_ext',
                      self.gf('django.db.models.fields.CharField')(default='jpeg', max_length=32),
                      keep_default=False)

        # Adding unique constraint on 'Photo', fields ['hash']
        db.create_unique('mainapp_photo', ['hash'])


    def backwards(self, orm):
        # Removing unique constraint on 'Photo', fields ['hash']
        db.delete_unique('mainapp_photo', ['hash'])
        ...
        db.add_column('mainapp_photo', 'external_url',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2048, blank=True),
                      keep_default=False)

        # Deleting field 'Photo.revisions'
        db.delete_column('mainapp_photo', 'revisions')

        # Deleting field 'Photo.revision_set'
        db.delete_column('mainapp_photo', 'revision_set')

        # Deleting field 'Photo.fn_ext'
        db.delete_column('mainapp_photo', 'fn_ext')
    ...
    models = {
        ...
        'mainapp.location': {
            ...
            'slug': ('django.db.models.fields.CharField', [], {'max_length': '256', 'unique': 'True', 'null': 'True'})
        },
        'mainapp.photo': {
            ...
            'fn_ext': ('django.db.models.fields.CharField', [], {'default': "'jpeg'", 'max_length': '32'}),
            ...
            'revision_set': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'revisions': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
        ...
        'mainapp.set': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'published': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'slug': ('django.db.models.fields.CharField', [], {'max_length': '512', 'unique': 'True', 'null': 'True'}),
