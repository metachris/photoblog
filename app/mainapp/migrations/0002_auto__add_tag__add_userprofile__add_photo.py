...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('mainapp_photo', (
            ...
            ('description_md', self.gf('django.db.models.fields.CharField')(max_length=10240)),
            ('description_html', self.gf('django.db.models.fields.CharField')(max_length=10240)),
            ('date_captured', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
    ...
    models = {
        ...
        'mainapp.photo': {
            ...
            'date_captured': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'description_html': ('django.db.models.fields.CharField', [], {'max_length': '10240'}),
            'description_md': ('django.db.models.fields.CharField', [], {'max_length': '10240'}),
