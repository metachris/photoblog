...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Photo.feature'
        db.delete_column('mainapp_photo', 'feature')

        # Adding field 'Photo.featured'
        db.add_column('mainapp_photo', 'featured',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Photo.feature'
        db.add_column('mainapp_photo', 'feature',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'Photo.featured'
        db.delete_column('mainapp_photo', 'featured')
