...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Photo.description_html'
        db.alter_column('mainapp_photo', 'description_html', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Photo.description_md'
        db.alter_column('mainapp_photo', 'description_md', self.gf('django.db.models.fields.TextField')(null=True))
        # Adding field 'Set.description_md'
        db.add_column('mainapp_set', 'description_md',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Set.description_html'
        db.add_column('mainapp_set', 'description_html',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Photo.description_html'
        db.alter_column('mainapp_photo', 'description_html', self.gf('django.db.models.fields.CharField')(default='', max_length=10240))

        # Changing field 'Photo.description_md'
        db.alter_column('mainapp_photo', 'description_md', self.gf('django.db.models.fields.CharField')(default='', max_length=10240))
        # Deleting field 'Set.description_md'
        db.delete_column('mainapp_set', 'description_md')

        # Deleting field 'Set.description_html'
        db.delete_column('mainapp_set', 'description_html')
