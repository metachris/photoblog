...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Photo.exif_camera'
        db.add_column('mainapp_photo', 'exif_camera',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Photo.exif_lens'
        db.add_column('mainapp_photo', 'exif_lens',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Photo.exif_exposuretime'
        db.add_column('mainapp_photo', 'exif_exposuretime',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Photo.exif_aperture'
        db.add_column('mainapp_photo', 'exif_aperture',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Photo.exif_iso'
        db.add_column('mainapp_photo', 'exif_iso',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Photo.exif_focallength'
        db.add_column('mainapp_photo', 'exif_focallength',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Photo.exif_flash'
        db.add_column('mainapp_photo', 'exif_flash',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Photo.exif_camera'
        db.delete_column('mainapp_photo', 'exif_camera')

        # Deleting field 'Photo.exif_lens'
        db.delete_column('mainapp_photo', 'exif_lens')

        # Deleting field 'Photo.exif_exposuretime'
        db.delete_column('mainapp_photo', 'exif_exposuretime')

        # Deleting field 'Photo.exif_aperture'
        db.delete_column('mainapp_photo', 'exif_aperture')

        # Deleting field 'Photo.exif_iso'
        db.delete_column('mainapp_photo', 'exif_iso')

        # Deleting field 'Photo.exif_focallength'
        db.delete_column('mainapp_photo', 'exif_focallength')

        # Deleting field 'Photo.exif_flash'
        db.delete_column('mainapp_photo', 'exif_flash')
