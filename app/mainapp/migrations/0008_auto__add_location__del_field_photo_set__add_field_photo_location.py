...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('mainapp_location', (
            ...
            ('slug', self.gf('django.db.models.fields.CharField')(max_length=256, null=True)),
        ...
        db.send_create_signal('mainapp', ['Location'])

        # Deleting field 'Photo.set'
        db.delete_column('mainapp_photo', 'set_id')

        # Adding field 'Photo.location'
        db.add_column('mainapp_photo', 'location',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mainapp.Location'], null=True, blank=True),
                      keep_default=False)

        # Adding M2M table for field set on 'Photo'
        db.create_table('mainapp_photo_set', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('photo', models.ForeignKey(orm['mainapp.photo'], null=False)),
            ('set', models.ForeignKey(orm['mainapp.set'], null=False))
        ))
        db.create_unique('mainapp_photo_set', ['photo_id', 'set_id'])


    def backwards(self, orm):
        # Deleting model 'Location'
        db.delete_table('mainapp_location')

        # Adding field 'Photo.set'
        db.add_column('mainapp_photo', 'set',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mainapp.Set'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Photo.location'
        db.delete_column('mainapp_photo', 'location_id')

        # Removing M2M table for field set on 'Photo'
        db.delete_table('mainapp_photo_set')
    ...
    models = {
        ...
        'mainapp.photo': {
            ...
            'set': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['mainapp.Set']", 'null': 'True', 'blank': 'True'}),
