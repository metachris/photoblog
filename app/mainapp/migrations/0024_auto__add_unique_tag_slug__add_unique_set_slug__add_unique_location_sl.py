...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique('mainapp_tag', ['slug'])

        # Adding unique constraint on 'Set', fields ['slug']
        db.create_unique('mainapp_set', ['slug'])

        # Adding unique constraint on 'Location', fields ['slug']
        db.create_unique('mainapp_location', ['slug'])

        # Adding unique constraint on 'Photo', fields ['slug']
        db.create_unique('mainapp_photo', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Photo', fields ['slug']
        db.delete_unique('mainapp_photo', ['slug'])

        # Removing unique constraint on 'Location', fields ['slug']
        db.delete_unique('mainapp_location', ['slug'])

        # Removing unique constraint on 'Set', fields ['slug']
        db.delete_unique('mainapp_set', ['slug'])

        # Removing unique constraint on 'Tag', fields ['slug']
        db.delete_unique('mainapp_tag', ['slug'])
