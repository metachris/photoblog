...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Photo.date_captured'
        db.alter_column('mainapp_photo', 'date_captured', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Photo.date_captured'
        db.alter_column('mainapp_photo', 'date_captured', self.gf('django.db.models.fields.DateTimeField')(null=True))
