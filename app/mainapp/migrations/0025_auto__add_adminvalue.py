...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AdminValue'
        db.create_table('mainapp_adminvalue', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('key', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('val', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('mainapp', ['AdminValue'])


    def backwards(self, orm):
        # Deleting model 'AdminValue'
        db.delete_table('mainapp_adminvalue')
