...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Handout.date_notified_contacts'
        db.add_column('mainapp_handout', 'date_notified_contacts',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Handout.date_notified_contacts'
        db.delete_column('mainapp_handout', 'date_notified_contacts')
