...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Photo.filesize_mb'
        db.add_column('mainapp_photo', 'filesize_mb',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Photo.upload_filename'
        db.add_column('mainapp_photo', 'upload_filename',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Photo.upload_filesize_mb'
        db.add_column('mainapp_photo', 'upload_filesize_mb',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Photo.upload_filename_from'
        db.add_column('mainapp_photo', 'upload_filename_from',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Photo.filesize_mb'
        db.delete_column('mainapp_photo', 'filesize_mb')

        # Deleting field 'Photo.upload_filename'
        db.delete_column('mainapp_photo', 'upload_filename')

        # Deleting field 'Photo.upload_filesize_mb'
        db.delete_column('mainapp_photo', 'upload_filesize_mb')

        # Deleting field 'Photo.upload_filename_from'
        db.delete_column('mainapp_photo', 'upload_filename_from')
    ...
    models = {
        ...
        'mainapp.photo': {
            ...
            'filesize_mb': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'hash': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'upload_filesize_mb': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
