...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Set.published'
        db.add_column('mainapp_set', 'published',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Photo.published'
        db.add_column('mainapp_photo', 'published',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Set.published'
        db.delete_column('mainapp_set', 'published')

        # Deleting field 'Photo.published'
        db.delete_column('mainapp_photo', 'published')
