...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Handout.has_notified_contacts'
        db.add_column('mainapp_handout', 'has_notified_contacts',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Handout.has_notified_contacts'
        db.delete_column('mainapp_handout', 'has_notified_contacts')
