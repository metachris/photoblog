...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('mainapp_photo', 'title', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Photo.title'
        db.alter_column('mainapp_photo', 'title', self.gf('django.db.models.fields.CharField')(max_length=100))
