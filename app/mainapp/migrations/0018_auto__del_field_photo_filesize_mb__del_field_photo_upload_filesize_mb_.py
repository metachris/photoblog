...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('mainapp_photo', 'filesize',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Photo.upload_filesize'
        db.add_column('mainapp_photo', 'upload_filesize',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('mainapp_photo', 'filesize')

        # Deleting field 'Photo.upload_filesize'
        db.delete_column('mainapp_photo', 'upload_filesize')
    ...
    models = {
        ...
        'mainapp.photo': {
            ...
            'filesize': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'hash': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'upload_filesize': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
