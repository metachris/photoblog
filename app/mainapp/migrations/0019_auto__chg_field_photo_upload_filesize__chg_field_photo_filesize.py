...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Photo.upload_filesize'
        db.alter_column('mainapp_photo', 'upload_filesize', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Photo.filesize'
        db.alter_column('mainapp_photo', 'filesize', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Photo.upload_filesize'
        db.alter_column('mainapp_photo', 'upload_filesize', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Photo.filesize'
        db.alter_column('mainapp_photo', 'filesize', self.gf('django.db.models.fields.FloatField')(null=True))
